---
title: Hotline Protocol 1.9
source: HLProtocol - original.doc
author: Hotline Communications
date: 2003-05-07
language: en
---
...
|325|News path||
|326|News article ID||
|337|News article –|Delete child articles (1) or not (0)|
||recursive delete||
...
|IP address|Original|Include the port number|
||Current||
|Attributes|Searchable||
||Allow rating||
|Status flags|Active|Active or not|
||On-line|On-line or off-line|
|Number of users|||
