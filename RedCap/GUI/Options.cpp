...
:wxDialog(parent, id, title, pos, wxSize(400, 300))
{
	...
	SizerV->Add( opt_autoagree, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	SizerV->Add( opt_sjlc, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	SizerV->Add( opt_refus_privchat, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	SizerV->Add( opt_autoresponse, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	SizerCryptoV->Add( opt_crypto, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	SizerGlobal->Add(NotebookSizer, 0, wxALIGN_CENTER|wxALL, 5);

//	wxBoxSizer *SizerButton = new wxBoxSizer ( wxHORIZONTAL );

	wxButton *ok_opt_button;
	ok_opt_button = new wxButton( this, BUTTON_OK, wxT("Ok"), wxPoint(210, 240), wxDefaultSize,0);
	//SizerButton->Add(ok_opt_button, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

	wxButton *cancel_opt_button;
	cancel_opt_button = new wxButton( this, BUTTON_OK, wxT("Cancel"), wxPoint(300, 240), wxDefaultSize,0);
